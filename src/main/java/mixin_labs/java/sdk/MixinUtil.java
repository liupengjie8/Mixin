package main.java.mixin_labs.java.sdk;
...
public class MixinUtil {
  ...
  public static class JWTTokenGen {
    ...
    static String genToken(String uri, String body, RSAPrivateKey pkey, String appid, String sessionid) {
      return genToken("GET", uri, body, UUID.randomUUID().toString(),pkey,  appid,  sessionid);
    }

    static String genToken(String method, String uri, String body, RSAPrivateKey pkey, String appid, String sessionid) {
